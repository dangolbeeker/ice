...
var plugin = function (_a) {
    var getValue = _a.getValue, applyMethod = _a.applyMethod, onGetWebpackConfig = _a.onGetWebpackConfig;
    return __awaiter(void 0, void 0, void 0, function () {
        var exportName, distPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    exportName = 'logger';
                    distPath = path.join(getValue('TEMP_PATH'), exportName);
                    return [4 /*yield*/, fse.copy(path.join(__dirname, "../" + exportName), distPath)];
                case 1:
                    _b.sent();
