...
function getConfig(rootDir, ignore) {
    ...
    var requireDeps = mockFiles.reduce(function (pre, curr) {
        return pre.concat(analyzeMockDeps_1.default(curr));
    }, []);
    var onlySet = Array.from(new Set(__spreadArrays(requireDeps, mockFiles)));
...
function realApplyMock(app, ignore) {
    ...
    app.use(function (req, res, next) {
        var match = mockConfig.length && matchPath_1.default(req, mockConfig);
        if (match) {
