...
describe('Get entries by route info', function () {
    it('should get entry by normal route', function () {
        var route = {
            source: 'pages/Home/index',
            pageSource: 'pages/Home/index'
        };
        var entries = getEntriesByRoute_1.default(route, '');
    ...
    it('should not get entry by empty route', function () {
        var route = {};
        var entries = getEntriesByRoute_1.default(route, '');
        expect(entries).toStrictEqual([]);
    });
    it('should get enties by frames and tabHeader', function () {
        var route = {
            source: "pages/Home/index",
            pageSource: 'pages/Home/index',
            frames: [
