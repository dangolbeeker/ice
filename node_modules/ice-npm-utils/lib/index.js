...
var constant_1 = require("@iceworks/constant");
...
function getSatisfiesVersions(npm, range, registry) {
    return getVersions(npm, registry).then(function (versions) {
        return versions
            .filter(function (version) { return semver.satisfies(version, range); })
            .sort(function (a, b) {
...
function checkAliInternal() {
    return request({
        url: constant_1.ALI_CHECKNODE_URL,
        timeout: 3 * 1000,
...
function readPackageJSON(projectPath) {
    return __awaiter(this, void 0, void 0, function () {
        var packagePath, packagePathIsExist, content;
