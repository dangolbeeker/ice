...
function default_1(api) {
    return __awaiter(this, void 0, void 0, function () {
        var getValue, applyMethod, onGetWebpackConfig, templatePath, distPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    getValue = api.getValue, applyMethod = api.applyMethod, onGetWebpackConfig = api.onGetWebpackConfig;
                    templatePath = path.join(__dirname, '..', 'template');
                    distPath = path.join(getValue('TEMP_PATH'), 'request');
                    // move template to .ice/request
                    return [4 /*yield*/, fse.copy(templatePath, distPath)];
                case 1:
                    // move template to .ice/request
                    _a.sent();
                    return [4 /*yield*/, fse.copy(path.join(__dirname, 'types'), path.join(distPath, 'types'))];
                case 2:
                    _a.sent();
                    // .ice/index.ts:
                    // export * from './request';
