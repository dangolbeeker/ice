...
(function (global, factory) {
	...
	function createAppConfig (init, config) {
	  ...
	  var appConfig = {
	    ...
	    onLaunch: function onLaunch(options) {
	      ...
	      cache.setWindow(window); // In wechat miniprogram getCurrentPages() length is 0, so web bundle only can be executed in first page
	...
	function getBaseLifeCycles(route) {
	  return {
	    onLoad: function onLoad(query) {
	      ...
	      if ( !app.launched) {
	        ...
	        app.launched = true; // The real app show has passed when init function execute
	...
	function createPageConfig (route, lifeCycles) {
	  ...
	  }, getBaseLifeCycles(route), createEventProxy()); // Define page lifecycles, like onReachBottom
	...
	function createElementConfig () {
	  {
	    return _extends_1({
	      ...
	      mount: function mount() {
	        ...
	        var node = cache.getNode(this.properties.r.nodeId);
	        node._internal = this;
	      }
	    }));
	  }
