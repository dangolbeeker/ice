...
var PLUGIN_AUTH_DIR = 'auth';
function default_1(api) {
    return __awaiter(this, void 0, void 0, function () {
        var getValue, onGetWebpackConfig, applyMethod, iceTemp, templateSourceDir;
        return __generator(this, function (_a) {
            getValue = api.getValue, onGetWebpackConfig = api.onGetWebpackConfig, applyMethod = api.applyMethod;
            iceTemp = getValue('TEMP_PATH');
            templateSourceDir = path.join(__dirname, '../template');
